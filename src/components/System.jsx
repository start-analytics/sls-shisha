const System = () => {
	return (
		<section id="system" className="menu section pb-2">
			...
			<div className="container custom-container mx-auto my-5" style={{ fontWeight: "500" }}>
				{/* Row 1 */}
				<div className="row">
			...
			<div style={{ textAlign: "center" }} className="container custom-container2  mx-auto my-5">
