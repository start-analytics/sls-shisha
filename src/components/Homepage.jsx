...
const Homepage = () => {
	return (
		<>
			<Header />
			<Hero />
			<section id="access" className="menu section">
				{/* Section Title */}
						...
						<div className="col-lg-3 col-md-4">
							<div className="gallery-item">
								<a href="/sls-shisha/flavors">
									<div class="position-relative custom-img">
						...
						<div className="col-lg-3 col-md-4">
							<div className="gallery-item">
								<a href="/sls-shisha/snacks">
									<div class="position-relative custom-img">
										<img src={foodImg} alt="" className="img-fluid w-100 " />
							...
							<div className="gallery-item">
								<a href="/sls-shisha/system">
									<div class="position-relative">
										...
										<div className="position-absolute  custom-text">SYSTEM</div>{" "}
									</div>
								</a>
							</div>
						</div>
